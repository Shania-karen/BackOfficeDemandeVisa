...
/**
 * DTO pour Nouveau Titre : saisie complète avec tous les champs d'un individu
 */
public class NouveauTitreDTO {
    // ID de l'individu existant (optionnel - si on réutilise un existant)
    private Integer idIndividuExistant;
    ...
    // Getters et Setters
    public Integer getIdIndividuExistant() { return idIndividuExistant; }
    public void setIdIndividuExistant(Integer idIndividuExistant) { this.idIndividuExistant = idIndividuExistant; }
